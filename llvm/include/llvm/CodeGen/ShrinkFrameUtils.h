...
LLVM_ABI bool shrinkFrameGuardRejectEdge(const MachineFunction &MF,
...
LLVM_ABI bool shrinkFrameGuardRejectTailDuplicate(
...
LLVM_ABI bool shrinkFrameGuardRejectTailMerge(const MachineFunction &MF,
                                              const MachineBasicBlock &M1,
                                              const MachineBasicBlock &M2,
                                              const MachineBasicBlock &Dest,
                                              const MachineDominatorTree &DT);

/// Reject hoist into Prolog (before FrameSetup) or frame-related MI into
/// Epilog.
...
/// framed+frameless preds, and stack-touching code reachable before
/// dom(Prolog).
LLVM_ABI bool mustHoistShrinkFramePrologToEntry(const MachineFunction &MF,
...
LLVM_ABI bool isLegalOffPrologCSRSavePoint(const MachineFunction &MF,
                                           MachineBasicBlock *Prolog,
